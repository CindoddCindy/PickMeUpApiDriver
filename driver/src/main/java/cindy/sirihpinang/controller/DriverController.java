...
import cindy.sirihpinang.repository.DriverRepositoryInterface;
...
public class DriverController{
    ...
    public String save(@Body Driver t) {
        HashMap<String, Object> data = new HashMap<>();
    ...
    public String update(@Body Driver c) {
        HashMap<String, Object> data = new HashMap<>();
        if (repository.update(c.getId(), c.getName(), c.getEmail(), c.getPassword(), c.getDriverId(), c.getDriverComName())) {
